...
class batch_images_to_txt:
    ...
    def integration_unit_conversion(self):
        from grating_function_20190130_1 import GratingCalculationOnPicture
        self.xlabel = "nm"
    ...
    def save_to_txt(self):
        ...
        #print(result)
        np.savetxt( "data/"+"20190130_1" + self.filename[20:-4] + "cal" + ".txt", result, delimiter=' ',
...
plt.close()
path_picture = "data/rotated_20190130_1/"
save_path = "results/"
tif_files = []
counter = 0
...
np.savetxt("Energy_content_uJ"+'20190130_1_0.5N25'+".txt",integrated_energy_list, fmt='%.3E', delimiter='\t')
plt.show()
