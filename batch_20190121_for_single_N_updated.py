...
class batch_images_to_txt:
    ...
    def save_to_txt(self):
        ...
        #print(result)
        np.savetxt( "data/"+"20190121" + self.filename[20:-4] + "cal" + ".txt", result, delimiter=' ',
...
plt.close()
path_picture = "data/rotated_20190121/"
save_path = "results/"
tif_files = []
counter = 0
...
np.savetxt("Energy_content_uJ"+'20190121_0.5N25'+".txt",integrated_energy_list, fmt='%.3E', delimiter='\t')
plt.show()
