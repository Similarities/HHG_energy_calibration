...
class batch_images_to_txt:
    ...
    def open_and_integrate(self):
        ...
        from grating_function_20190129 import Open_and_Plot_Picture
    ...
    def save_to_txt(self):
        ...
        np.savetxt(self.filename +'_'+ self.xlabel+ "_"+self.description+ repr(self.result_binsize)+'_'+self.ylabel+".txt", self.result_binned_array, fmt='%.3E', delimiter='\t')
...
np.savetxt("Energy_content_uJ"+'20190129'+".txt",integrated_energy_list, fmt='%.3E', delimiter='\t')
